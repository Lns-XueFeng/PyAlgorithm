...
"""
动态规划是一种数学优化方法和计算机编程方法
它通过将复杂问题分解为更简单的子问题来简化问题，这些子问题以递归方式解决
如果一个问题可以通过将其分解为子问题并递归地找到子问题的最优解来最优地解决，那么它就具有最优子结构

动态规划主要是对纯递归的优化。
当我们看到一个递归解决方案，它对相同的输入进行了重复调用时，我们可以使用动态规划对其进行优化
其思想是简单地存储子问题的结果，以便在以后需要时不必重新计算它们
